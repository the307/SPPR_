...
def get_planned_balance_for_bp_suzun_data(master_df):
    ...
    V_suzun_lost_transp_vankor = _get_const(master_df,"V_suzun_lost_transp_vankor")
    V_suzun_lost_transp_suzun = _get_const(master_df,"V_suzun_lost_transp_suzun")
    ...
    G_suzun_mupn = _get_const(master_df,"G_suzun_mupn")
    F_suzun_vankor_total = _get_const(master_df,"F_suzun_vankor_total")
    G_suzun_buy = _get_const(master_df,"G_suzun_buy")
    return{
        ...
        "V_suzun_lost_transp_vankor":V_suzun_lost_transp_vankor,
        "V_suzun_lost_transp_suzun":V_suzun_lost_transp_suzun,
        ...
        "G_suzun_mupn":G_suzun_mupn,
        "F_suzun_vankor_total":F_suzun_vankor_total,
        "G_suzun_buy":G_suzun_buy,
    }

def get_planned_balance_for_bp_vo_data(master_df):
    V_vo_ost_np_nm = _get_const(master_df,"V_vo_ost_np_nm")
    V_vo_ost_app_nm = _get_const(master_df,"V_vo_ost_app_nm")
    V_vo_ost_tech_nm = _get_const(master_df,"V_vo_ost_tech_nm")
    V_vo_path_nm = _get_const(master_df,"V_vo_path_nm")
    Q_vo_oil = _get_const(master_df,"Q_vo_oil")
    Q_vo_condensate = _get_const(master_df,"Q_vo_condensate")
    V_vo_lost_oil = _get_const(master_df,"V_vo_lost_oil")
    V_vo_lost_cond = _get_const(master_df,"V_vo_lost_cond")
    G_vo_fuel = _get_const(master_df,"G_vo_fuel")
    G_vo_fill = _get_const(master_df,"G_vo_fill")
    V_vo_lost_transp = _get_const(master_df,"V_vo_lost_transp")
    G_vo_release = _get_const(master_df,"G_vo_release")
    V_vo_ost_np_km = _get_const(master_df,"V_vo_ost_np_km")
    V_vo_ost_app_km = _get_const(master_df,"V_vo_ost_app_km")
    V_vo_ost_tech_km = _get_const(master_df,"V_vo_ost_tech_km")
    V_vo_path_km = _get_const(master_df,"V_vo_path_km")
    F_vo_total = _get_const(master_df,"F_vo_total")
    return{
        "V_vo_ost_np_nm":V_vo_ost_np_nm,
        "V_vo_ost_app_nm":V_vo_ost_app_nm,
        "V_vo_ost_tech_nm":V_vo_ost_tech_nm,
        "V_vo_path_nm":V_vo_path_nm,
        "Q_vo_oil":Q_vo_oil,
        "Q_vo_condensate":Q_vo_condensate,
        "V_vo_lost_oil":V_vo_lost_oil,
        "V_vo_lost_cond":V_vo_lost_cond,
        "G_vo_fuel":G_vo_fuel,
        "G_vo_fill":G_vo_fill,
        "V_vo_lost_transp":V_vo_lost_transp,
        "G_vo_release":G_vo_release,
        "V_vo_ost_np_km":V_vo_ost_np_km,
        "V_vo_ost_app_km":V_vo_ost_app_km,
        "V_vo_ost_tech_km":V_vo_ost_tech_km,
        "V_vo_path_km":V_vo_path_km,
        "F_vo_total":F_vo_total
    }
def get_planned_balance_for_bp_lodochny_data(master_df):
    V_lodochny_ost_np_nm = _get_const(master_df,"V_lodochny_ost_np_nm")
    V_lodochny_ost_app_nm = _get_const(master_df,"V_lodochny_ost_app_nm")
    V_lodochny_ost_tech_nm = _get_const(master_df,"V_lodochny_ost_tech_nm")
    V_lodochny_path_nm = _get_const(master_df,"V_lodochny_path_nm")
    Q_lodochny_oil = _get_const(master_df,"Q_lodochny_oil")
    Q_lodochny_condensate = _get_const(master_df,"Q_lodochny_condensate")
    V_lodochny_lost_oil = _get_const(master_df,"V_lodochny_lost_oil")
    V_lodochny_lost_transp = _get_const(master_df,"V_lodochny_lost_transp")
    G_lodochny_fuel = _get_const(master_df,"G_lodochny_fuel")
    G_lodochny_release_rn_drillig = _get_const(master_df,"G_lodochny_release_rn_drillig")
    V_lodochny_ost_np_km = _get_const(master_df,"V_lodochny_ost_np_km")
    V_lodochny_ost_app_km = _get_const(master_df,"V_lodochny_ost_app_km")
    V_lodochny_ost_tech_km = _get_const(master_df,"V_lodochny_ost_tech_km")
    V_lodochny_path_km = _get_const(master_df,"V_lodochny_path_km")
    F_lodochny_total = _get_const(master_df,"F_lodochny_total")
    return{
        "V_lodochny_ost_np_nm":V_lodochny_ost_np_nm,
        "V_lodochny_ost_app_nm":V_lodochny_ost_app_nm,
        "V_lodochny_ost_tech_nm":V_lodochny_ost_tech_nm,
        "V_lodochny_path_nm":V_lodochny_path_nm,
        "Q_lodochny_oil":Q_lodochny_oil,
        "Q_lodochny_condensate":Q_lodochny_condensate,
        "V_lodochny_lost_oil":V_lodochny_lost_oil,
        "V_lodochny_lost_transp":V_lodochny_lost_transp,
        "G_lodochny_fuel":G_lodochny_fuel,
        "G_lodochny_release_rn_drillig":G_lodochny_release_rn_drillig,
        "V_lodochny_ost_np_km":V_lodochny_ost_np_km,
        "V_lodochny_ost_app_km":V_lodochny_ost_app_km,
        "V_lodochny_ost_tech_km":V_lodochny_ost_tech_km,
        "V_lodochny_path_km":V_lodochny_path_km,
        "F_lodochny_total":F_lodochny_total
    }
def get_planned_balance_for_bp_tagul_data(master_df):
    V_tagul_ost_np_nm = _get_const(master_df,"V_tagul_ost_np_nm")
    V_tagul_ost_app_nm = _get_const(master_df,"V_tagul_ost_app_nm")
    V_tagul_ost_tech_nm = _get_const(master_df,"V_tagul_ost_tech_nm")
    V_tagul_path_nm = _get_const(master_df,"V_tagul_path_nm")
    Q_tagul_oil = _get_const(master_df,"Q_tagul_oil")
    Q_tagul_condensate = _get_const(master_df,"Q_tagul_condensate")
    V_tagul_lost_oil = _get_const(master_df,"V_tagul_lost_oil")
    V_tagul_lost_transp = _get_const(master_df,"V_tagul_lost_transp")
    G_tagul_fuel = _get_const(master_df,"G_tagul_fuel")
    G_tagul_release_rn_drillig = _get_const(master_df,"G_tagul_release_rn_drillig")
    G_tagul_release_vpt_neftmash = _get_const(master_df,"G_tagul_release_vpt_neftmash")
    V_tagul_ost_np_km = _get_const(master_df,"V_tagul_ost_np_km")
    V_tagul_ost_app_km = _get_const(master_df,"V_tagul_ost_app_km")
    V_tagul_ost_tech_km = _get_const(master_df,"V_tagul_ost_tech_km")
    V_tagul_path_km = _get_const(master_df,"V_tagul_path_km")
    F_tagul_total = _get_const(master_df,"F_tagul_total")
    return{
        "V_tagul_ost_np_nm":V_tagul_ost_np_nm,
        "V_tagul_ost_app_nm":V_tagul_ost_app_nm,
        "V_tagul_ost_tech_nm":V_tagul_ost_tech_nm,
        "V_tagul_path_nm":V_tagul_path_nm,
        "Q_tagul_oil":Q_tagul_oil,
        "Q_tagul_condensate":Q_tagul_condensate,
        "V_tagul_lost_oil":V_tagul_lost_oil,
        "V_tagul_lost_transp":V_tagul_lost_transp,
        "G_tagul_fuel":G_tagul_fuel,
        "G_tagul_release_rn_drillig":G_tagul_release_rn_drillig,
        "G_tagul_release_vpt_neftmash":G_tagul_release_vpt_neftmash,
        "V_tagul_ost_np_km":V_tagul_ost_np_km,
        "V_tagul_ost_app_km":V_tagul_ost_app_km,
        "V_tagul_ost_tech_km":V_tagul_ost_tech_km,
        "V_tagul_path_km":V_tagul_path_km,
        "F_tagul_total":F_tagul_total
    }

def get_planned_balance_for_bp_vn_gtm_data(master_df, prev_month):
    V_cppn_1_0  = _get_day_value(master_df,"V_cppn_1_0", prev_month)
    V_vn_gtm_ost_dead_nm  = _get_const(master_df,"V_vn_gtm_ost_dead_nm")
    V_tstn_vn_0  = _get_day_value(master_df,"V_tstn_vn_0", prev_month)
    V_vn_gtm_ost_np_nm  = _get_const(master_df,"V_vn_gtm_ost_np_nm")
    V_vn_gtm_ost_app_nm  = _get_const(master_df,"V_vn_gtm_ost_app_nm")
    Q_vankor_month  =  _get_last_const(master_df, "Q_vankor_month")
    Q_vn_gtm_condensate  = _get_const(master_df,"Q_vn_gtm_condensate")
    F_vn_total  = _get_const(master_df,"F_vn_total")
    K_vn_prod  = _get_const(master_df,"K_vn_prod")
    K_vankor  = _get_const(master_df,"k_vankor")
    V_vn_gtm_lost_condensate  = _get_const(master_df,"V_vn_gtm_lost_condensate")
    G_vn_gtm_fuel  = _get_const(master_df,"G_vn_gtm_fuel")
    G_vn_gtm_fill  = _get_const(master_df,"G_vn_gtm_fill")
    G_buying_oil_month  =_get_last_const(master_df, "G_buying_oil_month")
    G_tagul_gtm_release_tbs  = _get_const(master_df,"G_tagul_gtm_release_tbs")
    G_vn_gtm_release_rn_drillig  = _get_const(master_df,"G_vn_gtm_release_rn_drillig")
    V_cppn_1  = _get_last_const(master_df,"V_cppn_1")
    V_vn_gtm_ost_rvs_clean_nm  = _get_const(master_df,"V_vn_gtm_ost_rvs_clean_nm")
    V_vn_gtm_ost_tov_nm  = _get_const(master_df,"V_vn_gtm_ost_tov_nm")
    V_tstn_vn = _get_last_const(master_df, "V_tstn_vn")
    return{
        "V_tstn_vn":V_tstn_vn,
        "V_cppn_1_0":V_cppn_1_0,
        "V_vn_gtm_ost_dead_nm":V_vn_gtm_ost_dead_nm,
        "V_tstn_vn_0":V_tstn_vn_0,
        "V_vn_gtm_ost_np_nm":V_vn_gtm_ost_np_nm,
        "V_vn_gtm_ost_app_nm":V_vn_gtm_ost_app_nm,
        "Q_vankor_month":Q_vankor_month,
        "Q_vn_gtm_condensate":Q_vn_gtm_condensate,
        "F_vn_total":F_vn_total,
        "K_vn_prod":K_vn_prod,
        "K_vankor":K_vankor,
        "V_vn_gtm_lost_condensate":V_vn_gtm_lost_condensate,
        "G_vn_gtm_fuel":G_vn_gtm_fuel,
        "G_vn_gtm_fill":G_vn_gtm_fill,
        "G_buying_oil_month":G_buying_oil_month,
        "G_tagul_gtm_release_tbs":G_tagul_gtm_release_tbs,
        "G_vn_gtm_release_rn_drillig":G_vn_gtm_release_rn_drillig,
        "V_cppn_1":V_cppn_1,
        "V_vn_gtm_ost_rvs_clean_nm":V_vn_gtm_ost_rvs_clean_nm,
        "V_vn_gtm_ost_tov_nm":V_vn_gtm_ost_tov_nm,
        
    }

def get_planned_balance_for_bp_suzun_gtm_data(master_df, prev_month):

    V_suzun_slu_0  = _get_day_value(master_df,"V_suzun_slu_0", prev_month)
    V_suzun_vslu_0  = _get_day_value(master_df,"V_suzun_vslu_0", prev_month)
    V_suzun_gtm_ost_cps_nm = _get_const(master_df,"V_suzun_gtm_ost_cps_nm")
    V_suzun_gtm_ost_np_nm = _get_const(master_df,"V_suzun_gtm_ost_np_nm")
    V_suzun_gtm_ost_app_nm = _get_const(master_df,"V_suzun_gtm_ost_app_nm")
    V_suzun_0  = _get_day_value(master_df,"V_suzun_0", prev_month)
    V_tstn_suzun_vankor_0  = _get_day_value(master_df,"V_tstn_suzun_vankor_0", prev_month)
    V_tstn_suzun_vslu_0  = _get_day_value(master_df,"V_tstn_suzun_vslu_0", prev_month)
    Q_suzun_month = _get_last_const(master_df,"Q_suzun_month")
    Q_vslu_month = _get_last_const(master_df,"Q_vslu_month")
    Q_suzun_gtm_condensate = _get_const(master_df,"Q_suzun_gtm_condensate")
    K_suzun_prod = _get_const(master_df,"K_suzun_prod")
    G_per_month = _get_last_const(master_df,"G_per_month")
    G_suzun_gtm_fuel = _get_const(master_df,"G_suzun_gtm_fuel")
    G_buying_oil_month = _get_last_const(master_df,"G_buying_oil_month")
    F_suzun_sum = _get_last_const(master_df,"F_suzun_sum")
    F_suzun_vslu_sum = _get_last_const(master_df,"F_suzun_vslu_sum")
    F_suzun_vankor_sum = _get_last_const(master_df,"F_suzun_vankor_sum")
    K_suzun = _get_const(master_df,"k_suzun")
    K_vankor = _get_const(master_df,"k_vankor")
    V_suzun_gtm_ost_dead_nm = _get_const(master_df,"V_suzun_gtm_ost_dead_nm")
    V_suzun_gtm_ost_tov_nm = _get_const(master_df,"V_suzun_gtm_ost_tov_nm")
    V_suzun_slu = _get_last_const(master_df,"V_suzun_slu")
    V_suzun_vslu = _get_last_const(master_df,"V_suzun_vslu")
    G_suzun_gtm_release_rn_drillig = _get_const(master_df,"G_suzun_gtm_release_rn_drillig")
    V_suzun_gtm_ost_rvs_clean_nm = _get_const(master_df,"V_suzun_gtm_ost_rvs_clean_nm")
    V_tstn_suzun_vankor = _get_const(master_df,"V_tstn_suzun_vankor")
    V_tstn_suzun = _get_const(master_df,"V_tstn_suzun")
    V_tstn_suzun_vslu = _get_const(master_df,"V_tstn_suzun_vslu")
    return{
        "V_suzun_gtm_ost_cps_nm":V_suzun_gtm_ost_cps_nm,
        "V_suzun_gtm_ost_np_nm":V_suzun_gtm_ost_np_nm,
        "V_suzun_slu_0":V_suzun_slu_0,
        "V_suzun_vslu_0":V_suzun_vslu_0,
        "V_suzun_gtm_ost_app_nm":V_suzun_gtm_ost_app_nm,
        "V_suzun_0":V_suzun_0,
        "V_tstn_suzun_vankor_0":V_tstn_suzun_vankor_0,
        "V_tstn_suzun_vslu_0":V_tstn_suzun_vslu_0,
        "Q_suzun_month":Q_suzun_month,
        "Q_vslu_month":Q_vslu_month,
        "Q_suzun_gtm_condensate":Q_suzun_gtm_condensate,
        "K_suzun_prod":K_suzun_prod,
        "G_per_month":G_per_month,
        "G_suzun_gtm_fuel":G_suzun_gtm_fuel,
        "G_buying_oil_month":G_buying_oil_month,
        "F_suzun_sum":F_suzun_sum,
        "F_suzun_vslu_sum":F_suzun_vslu_sum,
        "F_suzun_vankor_sum":F_suzun_vankor_sum,
        "K_suzun":K_suzun,
        "K_vankor":K_vankor,
        "V_suzun_gtm_ost_dead_nm":V_suzun_gtm_ost_dead_nm,
        "V_suzun_gtm_ost_tov_nm":V_suzun_gtm_ost_tov_nm,
        "V_suzun_slu":V_suzun_slu,
        "V_suzun_vslu":V_suzun_vslu,
        "G_suzun_gtm_release_rn_drillig":G_suzun_gtm_release_rn_drillig,
        "V_suzun_gtm_ost_rvs_clean_nm":V_suzun_gtm_ost_rvs_clean_nm,
        "V_tstn_suzun_vankor":V_tstn_suzun_vankor,
        "V_tstn_suzun":V_tstn_suzun,
        "V_tstn_suzun_vslu":V_tstn_suzun_vslu,
    
    }
def get_planned_balance_for_bp_vo_gtm_data(master_df, prev_month):
    V_ichem_0  = _get_day_value(master_df,"V_ichem_0", prev_month)
    V_vo_gtm_ost_dead_nm  = _get_const(master_df,"V_vo_gtm_ost_dead_nm")
    V_vo_gtm_ost_tech_nm  = _get_const(master_df,"V_vo_gtm_ost_tech_nm")
    V_vo_gtm_ost_tov_nm  = _get_const(master_df,"V_vo_gtm_ost_tov_nm")
    V_tstn_vo_0  = _get_day_value(master_df,"V_tstn_vo_0", prev_month)
    V_vo_gtm_ost_np_nm  = _get_const(master_df,"V_vo_gtm_ost_np_nm")
    V_vo_gtm_ost_app_nm  = _get_const(master_df,"V_vo_gtm_ost_app_nm")
    Q_vo_month = _get_last_const(master_df,"Q_vo_month")
    Q_vo_gtm_condensate  = _get_const(master_df,"Q_vo_gtm_condensate")
    F_vo_sum = _get_last_const(master_df,"F_vo_sum")
    K_vo_prod  = _get_const(master_df,"K_vo_prod")
    K_vo_transp  = _get_const(master_df,"K_vo_transp")
    V_vo_gtm_lost_condensate  = _get_const(master_df,"V_vo_gtm_lost_condensate")
    G_vo_gtm_fuel  = _get_const(master_df,"G_vo_gtm_fuel")
    G_vo_gtm_fill  = _get_const(master_df,"G_vo_gtm_fill")
    V_ichem = _get_last_const(master_df,"V_ichem")
    G_vo_gtm_release  = _get_const(master_df,"G_vo_gtm_release")
    V_tstn_vo  = _get_last_const(master_df,"V_tstn_vo")
    return{
        "V_ichem_0":V_ichem_0,
        "V_vo_gtm_ost_dead_nm":V_vo_gtm_ost_dead_nm,
        "V_vo_gtm_ost_tech_nm":V_vo_gtm_ost_tech_nm,
        "V_vo_gtm_ost_tov_nm":V_vo_gtm_ost_tov_nm,
        "V_tstn_vo_0":V_tstn_vo_0,
        "V_vo_gtm_ost_np_nm":V_vo_gtm_ost_np_nm,
        "V_vo_gtm_ost_app_nm":V_vo_gtm_ost_app_nm,
        "Q_vo_month":Q_vo_month,
        "Q_vo_gtm_condensate":Q_vo_gtm_condensate,
        "F_vo_sum":F_vo_sum,
        "K_vo_prod":K_vo_prod,
        "K_vo_transp":K_vo_transp,
        "V_vo_gtm_lost_condensate":V_vo_gtm_lost_condensate,
        "G_vo_gtm_fuel":G_vo_gtm_fuel,
        "G_vo_gtm_fill":G_vo_gtm_fill,
        "V_ichem":V_ichem,
        "G_vo_gtm_release":G_vo_gtm_release,
        "V_tstn_vo":V_tstn_vo
    }



def get_planned_balance_for_bp_lodochny_gtm_data(master_df, prev_month):
    V_lodochny_0  = _get_day_value(master_df,"V_lodochny_0", prev_month)
    V_lodochny_gtm_ost_upn_ichem_nm  = _get_const(master_df,"V_lodochny_gtm_ost_upn_ichem_nm")
    V_lodochny_gtm_ost_upsv_yu_nm  = _get_const(master_df,"V_lodochny_gtm_ost_upsv_yu_nm")
    V_tstn_lodochny_0  = _get_day_value(master_df,"V_tstn_lodochny_0", prev_month)
    V_lodochny_gtm_ost_np_nm  = _get_const(master_df,"V_lodochny_gtm_ost_np_nm")
    V_lodochny_gtm_ost_app_nm  = _get_const(master_df,"V_lodochny_gtm_ost_app_nm")
    Q_lodochny_month = _get_last_const(master_df,"Q_lodochny_month")
    Q_lodochny_gtm_condensate  = _get_const(master_df,"Q_lodochny_gtm_condensate")
    F_tagul_lpu_sum = _get_last_const(master_df,"F_tagul_lpu_sum")
    K_lodochny_prod  = _get_const(master_df,"K_lodochny_prod")
    K_lodochny_transp  = _get_const(master_df,"K_lodochny_transp")
    V_lodochny_gtm_ost_dead_nm  = _get_const(master_df,"V_lodochny_gtm_ost_dead_nm")
    V_lodochny_gtm_ost_tov_nm  = _get_const(master_df,"V_lodochny_gtm_ost_tov_nm")
    V_lodochny_gtm_ost_rvs_clean_nm  = _get_const(master_df,"V_lodochny_gtm_ost_rvs_clean_nm")
    V_lodochny = _get_last_const(master_df,"V_lodochny")
    G_lodochny_gtm_release  = _get_const(master_df,"G_lodochny_gtm_release")
    G_lodochny_gtm_own  = _get_const(master_df,"G_lodochny_gtm_own")
    V_tstn_lodochny  = _get_last_const(master_df,"V_tstn_lodochny")
    return{
        "V_lodochny_0":V_lodochny_0,
        "V_lodochny_gtm_ost_upn_ichem_nm":V_lodochny_gtm_ost_upn_ichem_nm,
        "V_lodochny_gtm_ost_upsv_yu_nm":V_lodochny_gtm_ost_upsv_yu_nm,
        "V_tstn_lodochny_0":V_tstn_lodochny_0,
        "V_lodochny_gtm_ost_np_nm":V_lodochny_gtm_ost_np_nm,
        "V_lodochny_gtm_ost_app_nm":V_lodochny_gtm_ost_app_nm,
        "Q_lodochny_month":Q_lodochny_month,
        "Q_lodochny_gtm_condensate":Q_lodochny_gtm_condensate,
        "F_tagul_lpu_sum":F_tagul_lpu_sum,
        "K_lodochny_prod":K_lodochny_prod,
        "K_lodochny_transp":K_lodochny_transp,
        "V_lodochny_gtm_ost_dead_nm":V_lodochny_gtm_ost_dead_nm,
        "V_lodochny_gtm_ost_tov_nm":V_lodochny_gtm_ost_tov_nm,
        "V_lodochny_gtm_ost_rvs_clean_nm":V_lodochny_gtm_ost_rvs_clean_nm,
        "V_lodochny":V_lodochny,
        "G_lodochny_gtm_release":G_lodochny_gtm_release,
        "G_lodochny_gtm_own":G_lodochny_gtm_own,
        "V_tstn_lodochny":V_tstn_lodochny
    }
def get_planned_balance_for_bp_tagul_gtm_data(master_df, prev_month):
    V_tagul_gtm_ost_dead_nm = _get_const(master_df, "V_tagul_gtm_ost_dead_nm")
    V_tagul_gtm_ost_tech_nm = _get_const(master_df, "V_tagul_gtm_ost_tech_nm")
    V_tagul_gtm_ost_rvs_clean_nm = _get_const(master_df, "V_tagul_gtm_ost_rvs_clean_nm")
    V_tagul_gtm_ost_tov_nm = _get_const(master_df, "V_tagul_gtm_ost_tov_nm")
    V_tagul_gtm_ost_np_nm = _get_const(master_df, "V_tagul_gtm_ost_np_nm")
    V_tagul_gtm_ost_app_nm = _get_const(master_df, "V_tagul_gtm_ost_app_nm")
    V_tstn_tagul_0  = _get_day_value(master_df,"V_tstn_tagul_0", prev_month)
    Q_tagul_month = _get_last_const(master_df,"Q_tagul_month")
    Q_tagul_gtm_condensate = _get_const(master_df, "Q_tagul_gtm_condensate")
    F_tagul_tpu_sum = _get_last_const(master_df,"F_tagul_tpu_sum")
    K_tagul_prod = _get_const(master_df, "K_tagul_prod")
    K_tagul = _get_const(master_df, "K_tagul")
    G_tagul_gtm_fuel = _get_const(master_df, "G_tagul_gtm_fuel")
    G_tagul_gtm_release_rn_drillig = _get_const(master_df, "G_tagul_gtm_release_rn_drillig")
    G_tagul_gtm_release_rr = _get_const(master_df, "G_tagul_gtm_release_rr")
    V_tagul_gtm_ost_np_km = _get_const(master_df, "V_tagul_gtm_ost_np_km")
    V_tagul_gtm_ost_app_km = _get_const(master_df, "V_tagul_gtm_ost_app_km")
    V_tstn_tagul = _get_last_const(master_df,"V_tstn_tagul")
    return{
        "V_tagul_gtm_ost_dead_nm":V_tagul_gtm_ost_dead_nm,
        "V_tagul_gtm_ost_tech_nm":V_tagul_gtm_ost_tech_nm,
        "V_tagul_gtm_ost_rvs_clean_nm":V_tagul_gtm_ost_rvs_clean_nm,
        "V_tagul_gtm_ost_tov_nm":V_tagul_gtm_ost_tov_nm,
        "V_tagul_gtm_ost_np_nm":V_tagul_gtm_ost_np_nm,
        "V_tagul_gtm_ost_app_nm":V_tagul_gtm_ost_app_nm,
        "V_tstn_tagul_0":V_tstn_tagul_0,
        "Q_tagul_month":Q_tagul_month,
        "Q_tagul_gtm_condensate":Q_tagul_gtm_condensate,
        "F_tagul_tpu_sum":F_tagul_tpu_sum,
        "K_tagul_prod":K_tagul_prod,
        "K_tagul":K_tagul,
        "G_tagul_gtm_fuel":G_tagul_gtm_fuel,
        "G_tagul_gtm_release_rn_drillig":G_tagul_gtm_release_rn_drillig,
        "G_tagul_gtm_release_rr":G_tagul_gtm_release_rr,
        "V_tagul_gtm_ost_np_km":V_tagul_gtm_ost_np_km,
